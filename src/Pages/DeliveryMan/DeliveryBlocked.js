...
import DeliveryBlockedTable from "../../Components/Tables/DeliveryMan/DeliveryBlockedTable";
...
const DeliveryBlocked = () => {
  ...
  useEffect(() => {
    const filteredRidersByStatus = filteredRidersBySearch?.filter(
      (rider) => rider?.rider_status?.toLowerCase() === "blocked"
    );
    setBlockedRiders(filteredRidersByStatus);
  }, [filteredRidersBySearch]);
